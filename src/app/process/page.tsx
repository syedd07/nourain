...
import { MdEngineering, MdOutlineConstruction  } from "react-icons/md";
import AOS from "aos";
  ...
  const processes = [
    {
      id: 1,
      title: "Consultation",
      description: "We begin by understanding your business needs, goals, and target audience through in-depth consultations. Our team conducts thorough market research and competitor analysis to ensure we create a solution that stands out.",
    ...
    },
    {
      id: 2,
      title: "Site Visit",
      description: "Our team develops a comprehensive strategy and roadmap tailored to your specific requirements. We create detailed project timelines, resource allocation plans, and define clear milestones for success.",
    ...
    },
    {
      ...
      description: "We create stunning designs and develop robust solutions using cutting-edge technologies. Our experienced team ensures that every aspect of your project is crafted with precision and attention to detail.",
    ...
    },
    {
      ...
      description: "Rigorous testing and quality assurance ensure your solution meets the highest standards. We perform comprehensive testing across multiple platforms and scenarios to guarantee reliability.",
    ...
    },
    {
      id: 5,
      title: "Installation",
      description: "We deploy your solution and provide ongoing support to ensure continued success and growth. Our team remains committed to your project's success with continuous monitoring and optimization.",
    ...
    },
    {
      id: 6,
      title: "Maintenance",
      description: "We provide regular maintenance and updates to keep your solution running smoothly. Our team ensures that your project remains up-to-date with the latest technologies and trends.",
      icon: <FaRocket className="text-4xl text-blue-500" />,
    ...
    <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-4 sm:px-6 lg:px-8 mt-24">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-extrabold text-gray-900 mb-4" data-aos="fade-up">
            How we Work!
          </h2>
