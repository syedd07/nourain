...
const contact = () => {
    ...
    const validate = () => {
        let valid = true;
        let newErrors = { phoneNo: "", fullName: "", email: "", message: "" };
        ...
        if (!formData.phoneNo.trim()) {
            ...
            const phoneNoClean = formData.phoneNo.replace(/\s+/g, '');
            if (!/^\+?[1-9]\d{1,14}$/.test(phoneNoClean)) {
    ...
    return (
        <section className="py-12 px-4 sm:px-10 bg-white mt-20">
            <h2
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center relative overflow-hidden p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] before:absolute before:right-0 before:w-[300px] before:bg-blue-400 before:h-full max-md:before:hidden">
                    <div>
                        <form onSubmit={handleSubmit}>
                            ...
                            <button
                                type="submit"
                                className="mt-8 flex items-center justify-center text-sm w-full px-4 py-2.5 bg-blue-500 hover:bg-blue-700 text-white rounded-sm"
                            >
                                <svg
                        ...
                        <ul className="mt-4 flex flex-wrap justify-center gap-6">
                            <li className="flex items-center text-blue-600">
                                ...
                                <a href="mailto:info@nourain.ae" className="text-sm ml-3">
                                    <strong>info@nourain.ae</strong>
                                </a>
                            </li>
                            <li className="flex items-center text-blue-600">
                                <svg
                                ...
                                <a href="tel:+966560700103" className="text-sm ml-3">
                                    <strong>+966 560 700103</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
