...
const Features: React.FC = () => {
    return (
        <section className="rounded-md shadow-[0px_0px_10px_0px_rgba(255,_255,_255,_1)] py-12 px-4 sm:px-10 bg-white mx-4 md:mx-8 mt-8">
            <h2
                    ...
                    <div className="flex flex-wrap my-6 md:my-12">
                        ...
                        <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-4 md:p-8">
                            <div className="flex items-center mb-4 md:mb-6">
                                ...
                                <div className="ml-4 text-lg md:text-xl text-[#0c0207]">Expert Craftsmanship</div>
                            </div>
